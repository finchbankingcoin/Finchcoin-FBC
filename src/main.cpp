...
uint256 hashGenesisBlock("0x65f14893ab12a2accb06613eeb5ff096d88702c23ac0ddea874feb3e1c03080f");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Finchcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Finchcoin Signed Message:\n";
...
{
    // Finchcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1575000); // Finchcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Finchcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Finchcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Finchcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Finchcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Finchcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa116ecc8aa8ee53a5fa3402f97e0c6a6de1aa633117c3ab2092232f7c7e22519");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Another coin with finch";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("8a4a186544cbe207505e42e0ee1ab43a72034024ea0b3c1e40e66e6d1ca6fcff90d18bd2523219d492fcf41d8ace0c34c5915aea7772606232f38e576ed6a3b14d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1516645942;
        block.nBits    = 504365644;
        block.nNonce   = 1314167534;

        if (fTestNet)
        {
            block.nTime    = 1516645942;
            block.nNonce   = 3102285686;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8fe281c776b8a6f9719bd6df9f8276a8f8f45dae0286cb7fe7592656083f9d58"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Finchcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FinchcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FinchcoinMiner : ProcessBlock, block not accepted");
    }
